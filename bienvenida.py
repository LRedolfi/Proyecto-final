...
class Bienvenida(pygame.sprite.Sprite):
    ...
    def dibujar(self,superficie):
        ...
        self.texto.mostrar_texto('Oh, no! Las arañas están invadiendo la casa de Cody!',33,color_banner,ancho_ventana//2+2,10,superficie,None)
        ...
        self.texto.mostrar_texto('Quieres ayudar a Cody a limpiar su casa de las arañas?',33,color_banner,ancho_ventana//2+2,50,superficie,None)
        ...
        self.texto.mostrar_texto('Presiona cualquier tecla para continuar',33,color_banner,ancho_ventana//2+2,100,superficie,None)
