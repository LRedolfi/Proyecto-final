...
class Bienvenida_2(pygame.sprite.Sprite):
    ...
    def dibujar(self,superficie):
        ...
        self.texto.mostrar_texto('Con la flecha arriba inicia el juego',33,color_banner,ancho_ventana//2+2,60+2,superficie)
        self.texto.mostrar_texto('Con la flecha arriba inicia el juego',33,color_techo,ancho_ventana//2,60,superficie)
    ...
    def animación(self,imágenes,rectángulo,superficie):
        ...
        while esperar:
            ...
            self.piso.dibujar(superficie)
            self.jugador.dibujar_nuevamente(superficie)
            self.pelota.dibujar_nuevamente(superficie,self.jugador.rect.x)
