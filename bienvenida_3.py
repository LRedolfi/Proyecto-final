...
class Bienvenida_3(pygame.sprite.Sprite):
    ...
    def dibujar(self,superficie):
        ...
        self.texto.mostrar_texto('Con las flechas laterales mueves a Cody',33,color_banner,ancho_ventana//2+2,60+2,superficie)
        self.texto.mostrar_texto('Con las flechas laterales mueves a Cody',33,color_techo,ancho_ventana//2,60,superficie)
        self.texto.mostrar_texto('Presiona cualquier tecla para continuar',33,color_banner,ancho_ventana//2+2,110+2,superficie)
        self.texto.mostrar_texto('Presiona cualquier tecla para continuar',33,color_techo,ancho_ventana//2,110,superficie)
