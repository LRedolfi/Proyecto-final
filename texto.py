...
class Texto(pygame.sprite.Sprite): #defino la clase texto
    ...
    def dibujar_texto(self,superficie,puntaje,nivel,jugando,vidas,pausa,ganador,puntaje_máximo):
        ...
        if not jugando and vidas>0:
            self.mostrar_texto('Perdiste una vida!',50,color_banner,ancho_ventana//2+2,alto_ventana//2+2,superficie)
            self.mostrar_texto('Perdiste una vida!',50,color_techo,ancho_ventana//2,alto_ventana//2,superficie)
            self.mostrar_texto('Presiona r para continuar el juego',25,color_banner,ancho_ventana//2+2,alto_ventana//2+50+2,superficie)
            self.mostrar_texto('Presiona r para continuar el juego',25,color_techo,ancho_ventana//2,alto_ventana//2+50,superficie)
        if not jugando and vidas==0:
            self.mostrar_texto('PERDISTE!',50,color_banner,ancho_ventana//2+2,alto_ventana//2+2,superficie)
            self.mostrar_texto('PERDISTE!',50,color_techo,ancho_ventana//2,alto_ventana//2,superficie)
            self.mostrar_texto('Presiona r para reiniciar el juego',25,color_banner,ancho_ventana//2+2,alto_ventana//2+50+2,superficie)
            self.mostrar_texto('Presiona r para reiniciar el juego',25,color_techo,ancho_ventana//2,alto_ventana//2+50,superficie)
        if pausa:
            self.mostrar_texto('Juego pausado',50,color_banner,ancho_ventana//2+2,alto_ventana//2+2,superficie)
            self.mostrar_texto('Juego pausado',50,color_techo,ancho_ventana//2,alto_ventana//2,superficie)
            self.mostrar_texto('Presiona r para continuar el juego',25,color_banner,ancho_ventana//2+2,alto_ventana//2+60+2,superficie)
            self.mostrar_texto('Presiona r para continuar el juego',25,color_techo,ancho_ventana//2,alto_ventana//2+60,superficie)
        if ganador and vidas==0:
            self.mostrar_texto('Felicidades! Tu puntaje {} fue el mas alto!'.format(puntaje),25,color_banner,ancho_ventana//2+2,alto_ventana//2+85+2,superficie)
            self.mostrar_texto('Felicidades! Tu puntaje {} fue el mas alto!'.format(puntaje),25,color_techo,ancho_ventana//2,alto_ventana//2+85,superficie)
        if not ganador and vidas==0:
            self.mostrar_texto('Tu puntaje no supero el puntaje máximo de {}'.format(puntaje_máximo),25,color_banner,ancho_ventana//2+2,alto_ventana//2+85+2,superficie)
            self.mostrar_texto('Tu puntaje no supero el puntaje máximo de {}'.format(puntaje_máximo),25,color_techo,ancho_ventana//2,alto_ventana//2+85,superficie)